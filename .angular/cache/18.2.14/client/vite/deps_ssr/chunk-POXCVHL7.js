...
var CdkScrollable = class _CdkScrollable {
  ...
  _cleanupScroll;
  _elementScrolled = new import_rxjs2.Subject();
  constructor() {
  }
  ngOnInit() {
...
var OverlayRef = class {
  ...
  _backdropTimeout;
  _backdropClick = new import_rxjs3.Subject();
  _attachments = new import_rxjs3.Subject();
  _detachments = new import_rxjs3.Subject();
  _positionStrategy;
  _scrollStrategy;
  _locationChanges = import_rxjs3.Subscription.EMPTY;
  ...
  _keydownEvents = new import_rxjs3.Subject();
  /** Stream of mouse outside events dispatched to this overlay. */
  _outsidePointerEvents = new import_rxjs3.Subject();
  _renders = new import_rxjs3.Subject();
  _afterRenderRef;
...
var FlexibleConnectedPositionStrategy = class {
  ...
  _positionChanges = new import_rxjs3.Subject();
  /** Subscription to viewport size changes. */
  _resizeSubscription = import_rxjs3.Subscription.EMPTY;
...
var CdkConnectedOverlay = class _CdkConnectedOverlay {
  ...
  _overlayRef;
  _templatePortal;
  _backdropSubscription = import_rxjs3.Subscription.EMPTY;
  _attachSubscription = import_rxjs3.Subscription.EMPTY;
  _detachSubscription = import_rxjs3.Subscription.EMPTY;
  _positionSubscription = import_rxjs3.Subscription.EMPTY;
  _offsetX;
  _offsetY;
  _position;
...
//# sourceMappingURL=chunk-POXCVHL7.js.map
